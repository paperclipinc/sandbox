...
func TestForkRegistersTokenOnServer(t *testing.T) {
	...
	if _, err := srv.Fork(context.Background(), "py", "sb-tok", nil, nil, "tok-fork"); err != nil {
		t.Fatal(err)
	}
...
func TestForkWithEmptyTokenFailsClosed(t *testing.T) {
	...
	if _, err := srv.Fork(context.Background(), "py", "sb-naked", nil, nil, ""); err != nil {
		t.Fatal(err)
	}
...
func TestForkRunningRegistersToken(t *testing.T) {
	...
	if _, err := srv.Fork(context.Background(), "py", "parent", nil, nil, "tok-parent"); err != nil {
		t.Fatal(err)
	}
